...
import { Building2, Mail, Lock, AlertCircle, ChevronLeft, Eye, EyeOff, Loader2 } from 'lucide-react';
    ...
    <>
      ...
      <div className="lg:hidden min-h-screen bg-[#0d4f47] flex flex-col">
        ...
        <div style={{ background: 'linear-gradient(160deg,#0d4f47 0%,#0f766e 50%,#0e7490 100%)' }} className="pt-10 pb-8 px-6 text-center relative">
          ...
          <h1 className="text-xl font-extrabold text-white mb-1">Masjid Al-Falah</h1>
          <p className="text-sm text-white/60">Panel Pentadbir</p>
        </div>

        {/* WHITE CARD */}
        <div className="bg-white rounded-t-2xl -mt-3 relative flex-1 px-5 pt-5 pb-8">
          <h2 className="text-lg font-extrabold text-gray-900 mb-0.5">Log Masuk</h2>
          <p className="text-xs text-gray-400 mb-5">Masukkan kelayakan admin anda</p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between mb-5">
              ...
              <Link href="/admin/forgot-password" className="text-teal-600 font-semibold text-xs">
                Lupa Kata Laluan?
              </Link>
            </div>
          ...
          <button
            onClick={() => router.push('/')}
            className="flex items-center gap-1.5 text-gray-400 text-xs w-full justify-center"
          >
