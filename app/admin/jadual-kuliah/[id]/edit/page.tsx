...
export default function EditJadualKuliahPage() {
    ...
    const fetchData = async () => {
      try {
        const [data, kategoris] = await Promise.all([
          getJadualKuliahById(params.id as string),
          getActiveKategori(),
        ]);
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      await updateJadualKuliah(params.id as string, updateData);
  ...
  return (
    <div className="p-4 sm:p-6 space-y-6">
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Edit Kuliah</h1>
        ...
        <div className="bg-white rounded-lg shadow p-6 space-y-6">
          ...
          <div>
            ...
            <input
              ...
              disabled={saving}
            />
            {posterPreview || (existingPosterUrl && !posterRemoved) ? (
              <div className="relative w-full max-w-xs">
                ...
                <div className="absolute top-2 right-2 flex gap-1.5">
                  <button
                    ...
                    className="bg-white text-gray-700 p-1.5 rounded-full hover:bg-gray-100 transition-colors shadow-sm"
                    title="Tukar poster"
                    disabled={saving}
                  >
